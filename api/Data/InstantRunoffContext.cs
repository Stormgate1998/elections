...
namespace elections.Data
{
    public partial class InstantRunoffContext : DbContext
    {
        ...
        public virtual DbSet<Ballot1> Ballots1 { get; set; } = null!;
        public virtual DbSet<BallotPref> BallotPrefs { get; set; } = null!;
        public virtual DbSet<BallotPref1> BallotPrefs1 { get; set; } = null!;
        public virtual DbSet<Candidate> Candidates { get; set; } = null!;
        public virtual DbSet<Candidate1> Candidates1 { get; set; } = null!;
        ...
        public virtual DbSet<City1> Cities1 { get; set; } = null!;
        public virtual DbSet<County> Counties { get; set; } = null!;
        public virtual DbSet<County1> Counties1 { get; set; } = null!;
        public virtual DbSet<Election> Elections { get; set; } = null!;
        public virtual DbSet<Election1> Elections1 { get; set; } = null!;
        public virtual DbSet<Office> Offices { get; set; } = null!;
        public virtual DbSet<Office1> Offices1 { get; set; } = null!;
        ...
        public virtual DbSet<Tabulationresult1> Tabulationresults1 { get; set; } = null!;
        public virtual DbSet<Veffectiveballot> Veffectiveballots { get; set; } = null!;
        public virtual DbSet<Veffectiveballot1> Veffectiveballots1 { get; set; } = null!;
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("host=database-1.cisqkskacvfb.us-west-2.rds.amazonaws.com; database=instantrunoff; user id=iroapp; password=EasyToGuess");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ballot1>(entity =>
            {
                entity.ToTable("ballot", "iro2");
            ...
            {
                entity.ToTable("ballot_pref", "iro2");
            ...
            modelBuilder.Entity<BallotPref1>(entity =>
            {
            ...
            modelBuilder.Entity<Candidate1>(entity =>
            {
            ...
            modelBuilder.Entity<CandidateOffice>(entity =>
            {
                ...
                entity.HasOne(d => d.Election)
                    ...
                    .HasConstraintName("candidate_office_election_fk");
            ...
            {
                entity.ToTable("candidate_oie", "iro2");
            ...
            modelBuilder.Entity<County1>(entity =>
            {
                entity.ToTable("county", "iro2");
            ...
            modelBuilder.Entity<Election1>(entity =>
            {
            ...
            modelBuilder.Entity<Office1>(entity =>
            {
            ...
            {
                entity.ToTable("office_in_election", "iro2");
            ...
            modelBuilder.Entity<Tabulationresult>(entity =>
            {
                ...
                entity.Property(e => e.COId).HasColumnName("c_o_id");
            ...
            modelBuilder.Entity<Tabulationresult1>(entity =>
            {
                entity.ToTable("tabulationresult", "iro2");
                ...
                entity.HasOne(d => d.CandidateOie)
                    .WithMany(p => p.Tabulationresult1s)
                    .HasForeignKey(d => d.CandidateOieId)
                    .HasConstraintName("tabulation_candidateoffice_fk");
            });
            ...
            modelBuilder.Entity<Veffectiveballot1>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("veffectiveballot", "iro2");
